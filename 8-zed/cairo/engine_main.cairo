...
from cairo.constants.constants import (
    ns_stimulus,
    ns_combos,
    ns_scene,
    ns_stamina,
...
from cairo.constants.constants_jessica import ns_jessica_character_dimension
from cairo.body.body import _body
from cairo.combo import _combo
from cairo.physics import _physicality, _test_rectangle_overlap
from cairo.perceptibles import update_perceptibles
from lib.bto_cairo_git.lib.tree import Tree, BinaryOperatorTree
from cairo.utils import fill_dictionary_offsets, fill_dictionary

// func main{range_check_ptr}(){
//     let len = 120;

//     let combos_offset_0_len = 1;
//     let (combos_offset_0) = alloc();
//     assert combos_offset_0[0] = 0;
//     assert combos_offset_0[1] = 1;
//     let combos_0_len = 5;
//     let (combos_0) = alloc();
//     assert combos_0[0] = 1;
//     assert combos_0[1] = 1;
...
//     assert combos_0[3] = 1;
//     assert combos_0[4] = 1;
//     let combos_offset_1_len = 1;
//     let (combos_offset_1) = alloc();
//     assert combos_offset_1[0] = 0;
//     assert combos_offset_1[1] = 1;
//     let combos_1_len = 5;
//     let (combos_1) = alloc();
//     assert combos_1[0] = 1;
//     assert combos_1[1] = 1;
...
//     let agent_0_state_machine_offset_len = 2;
//     let (agent_0_state_machine_offset) = alloc();
//     assert agent_0_state_machine_offset[0] = 1;
//     assert agent_0_state_machine_offset[1] = 1;
//     let agent_0_state_machine_len = 1;
//     let (agent_0_state_machine: Tree*) = alloc();
//     assert agent_0_state_machine[0] = Tree(0, -1, -1);
//     let agent_0_initial_state = 0;
//     let agent_1_state_machine_offset_len = 2;
//     let (agent_1_state_machine_offset) = alloc();
//     assert agent_1_state_machine_offset[0] = 1;
//     assert agent_1_state_machine_offset[1] = 1;
//     let agent_1_state_machine_len = 1;
//     let (agent_1_state_machine: Tree*) = alloc();
//     assert agent_1_state_machine[0] = Tree(0, -1, -1);
//     let agent_1_initial_state = 0;
//     let agent_0_functions_offset_len = 1;
//     let (agent_0_functions_offset) = alloc();
//     assert agent_0_functions_offset[0] = 1;
//     let agent_0_functions_len = 1;
//     let (agent_0_functions: Tree*) = alloc();
//     assert agent_0_functions[0] = Tree(0, -1, -1);
//     let agent_1_functions_offset_len = 1;
//     let (agent_1_functions_offset) = alloc();
//     assert agent_1_functions_offset[0] = 1;
//     let agent_1_functions_len = 1;
//     let (agent_1_functions: Tree*) = alloc();
//     assert agent_1_functions[0] = Tree(0, -1, -1);
//     let actions_0_len = 1;
//     let (actions_0) = alloc();
//     assert actions_0[0] = 101;
//     let actions_1_len = 1;
//     let (actions_1) = alloc();
//     assert actions_1[0] = 101;
//     let character_type_0 = 0;
//     let character_type_1 = 1;
