...
func _physicality {range_check_ptr} (
    ...
    let (bool_object_in_active_0_) = _bool_or (bool_object_in_punch_atk_0, bool_object_in_power_atk_0)
    let (bool_object_in_active_0)  = _bool_or (bool_object_in_active_0_, bool_object_in_block_0)
    let (bool_object_in_active_1_) = _bool_or (bool_object_in_punch_atk_1, bool_object_in_power_atk_1)
