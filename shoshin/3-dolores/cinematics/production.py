...
def draw_background():
    ...
    pygame.draw.line(color_rect, BG_TOP_COLOR,
                     (0, 0), (1, 0))  # top color line
    pygame.draw.line(color_rect, BG_BOTTOM_COLOR,
                     (0, 1), (1, 1))  # bottom color line
    color_rect = pygame.transform.smoothscale(
        color_rect, (target_rect.width, target_rect.height))  # stretch
...
draw_background()
update_game_message('Shoshin milestone #3: Dolores')
update_stat_message('')
