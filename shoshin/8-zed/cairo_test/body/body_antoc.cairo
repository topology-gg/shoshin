...
//
func _body_antoc{range_check_ptr}(body_state: BodyState, stimulus: felt, intent: felt) -> (
    ...
    let (updated_stamina, enough_stamina) = calculate_stamina_change(
        stamina, intent, ns_stamina.INIT_STAMINA, ns_character_type.ANTOC
    );
    ...
    if (state == ns_antoc_body_state.IDLE) {
        ...
        if (stimulus == ns_stimulus.HURT) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.HURT, 0, updated_integrity, stamina, dir, FALSE),
            );
        }
        if (stimulus == ns_stimulus.KNOCKED) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.KNOCKED, 0, updated_integrity, stamina, dir, FALSE),
            );
        }
        ...
        if (intent == ns_antoc_action.MOVE_FORWARD) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.MOVE_FORWARD, 0, integrity, updated_stamina, dir, FALSE),
            );
        }
        if (intent == ns_antoc_action.MOVE_BACKWARD) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.MOVE_BACKWARD, 0, integrity, updated_stamina, dir, FALSE),
            );
        }
        if (intent == ns_antoc_action.BLOCK) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.BLOCK, 0, integrity, updated_stamina, dir, FALSE),
            );
        }
        if (enough_stamina == TRUE) {
            if (intent == ns_antoc_action.HORI) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.HORI, 0, integrity, updated_stamina, dir, FALSE),
                );
            }
            if (intent == ns_antoc_action.VERT) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.VERT, 0, integrity, updated_stamina, dir, FALSE),
                );
            }
            if (intent == ns_antoc_action.DASH_FORWARD) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.DASH_FORWARD, 0, integrity, updated_stamina, dir, FALSE),
                );
            }
            if (intent == ns_antoc_action.DASH_BACKWARD) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.DASH_BACKWARD, 0, integrity, updated_stamina, dir, FALSE),
                );
            }
            if (intent == ns_antoc_action.JUMP) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.JUMP, 0, integrity, updated_stamina, dir, FALSE),
                );
            }
            if (intent == ns_antoc_action.STEP_FORWARD) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.STEP_FORWARD, 0, integrity, updated_stamina, dir, FALSE),
                );
            }
        }
        ...
        let (updated_stamina, _) = calculate_stamina_change(
            stamina, ns_antoc_action.NULL, ns_stamina.INIT_STAMINA, ns_character_type.ANTOC
        );
        if (counter == ns_antoc_body_state_duration.IDLE - 1) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.IDLE, 0, integrity, updated_stamina, dir, is_fatigued),
            );
        } else {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.IDLE, counter + 1, integrity, updated_stamina, dir, is_fatigued),
            );
        }
    }
    ...
    if (state == ns_antoc_body_state.HORI) {
        ...
        if (stimulus == ns_stimulus.CLASH) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.CLASH, 0, updated_integrity, stamina, dir, FALSE),
            );
        }
        ...
        if (counter == ns_antoc_body_state_duration.HORI - 1) {
            if (intent == ns_antoc_action.HORI) {
                ...
                if (enough_stamina == TRUE) {
                    ...
                    return (
                        body_state_nxt=BodyState(ns_antoc_body_state.IDLE, 0, integrity, stamina, dir, TRUE),
                    );
                }
            }
            // otherwise return to IDLE
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.IDLE, 0, integrity, stamina, dir, FALSE),
            );
        } else {
            // increment counter
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.HORI, counter + 1, integrity, stamina, dir, FALSE),
            );
        }
    }
    ...
    if (state == ns_antoc_body_state.VERT) {
        ...
        if (counter == ns_antoc_body_state_duration.VERT - 1) {
            ...
            if (intent == ns_antoc_action.HORI) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.VERT, counter + 1, integrity, stamina, dir, TRUE),
                );
            }
            // increment counter
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.VERT, counter + 1, integrity, stamina, dir, FALSE),
            );
        }
    }
    ...
    if (state == ns_antoc_body_state.BLOCK) {
        ...
        if (enough_stamina == TRUE) {
            ...
            if (intent == ns_antoc_action.BLOCK) {
                if (counter == 2) {
                    ...
                    return (
                        body_state_nxt=BodyState(ns_antoc_body_state.BLOCK, counter, integrity, updated_stamina, dir, FALSE),
                    );
                } else {
                    // else increment counter
                    return (
                        body_state_nxt=BodyState(ns_antoc_body_state.BLOCK, counter + 1, integrity, updated_stamina, dir, FALSE),
                    );
                }
            }
        }
        ...
        // otherwise return to IDLE
        let (updated_stamina, _) = calculate_stamina_change(
            stamina, ns_antoc_action.BLOCK, ns_stamina.INIT_STAMINA, ns_character_type.ANTOC
        );
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.IDLE, 0, integrity, updated_stamina, dir, FALSE),
        );
    }
    ...
    if (state == ns_antoc_body_state.HURT) {
        ...
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.HURT, counter + 1, integrity, stamina, dir, FALSE),
        );
    }
    ...
    if (state == ns_antoc_body_state.KNOCKED) {
        ...
        if (counter == 6 and stimulus != ns_stimulus.GROUND) {
            return (
                body_state_nxt=BodyState(ns_antoc_body_state.KNOCKED, counter, integrity, stamina, dir, FALSE),
            );
        }

        // else stay in KNOCKED and increment counter
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.KNOCKED, counter + 1, integrity, stamina, dir, FALSE),
        );
    }
    ...
    if (state == ns_antoc_body_state.MOVE_FORWARD) {
        ...
        if (intent == ns_antoc_action.MOVE_FORWARD) {
            if (counter == ns_antoc_body_state_duration.MOVE_FORWARD - 1) {
                ...
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.MOVE_FORWARD, counter + 1, integrity, updated_stamina, dir, FALSE),
                );
            }
        }
        ...
        // otherwise return to idle
        let (updated_stamina, _) = calculate_stamina_change(
            stamina, ns_antoc_action.MOVE_FORWARD, ns_stamina.INIT_STAMINA, ns_character_type.ANTOC
        );
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.IDLE, 0, integrity, updated_stamina, dir, is_fatigued),
        );
    ...
    if (state == ns_antoc_body_state.MOVE_BACKWARD) {
        ...
        if (intent == ns_antoc_action.MOVE_BACKWARD) {
            if (counter == ns_antoc_body_state_duration.MOVE_BACKWARD - 1) {
                ...
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.MOVE_BACKWARD, counter + 1, integrity, updated_stamina, dir, FALSE),
                );
            }
        }
        ...
        // otherwise return to idle
        let (updated_stamina, _) = calculate_stamina_change(
            stamina, ns_antoc_action.MOVE_BACKWARD, ns_stamina.INIT_STAMINA, ns_character_type.ANTOC
        );
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.IDLE, 0, integrity, updated_stamina, dir, is_fatigued),
        );
    ...
    if (state == ns_antoc_body_state.DASH_FORWARD) {
        ...
        // increment counter
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.DASH_FORWARD, counter + 1, integrity, stamina, dir, FALSE),
        );
    }
    ...
    if (state == ns_antoc_body_state.DASH_BACKWARD) {
        ...
        // increment counter
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.DASH_BACKWARD, counter + 1, integrity, stamina, dir, FALSE),
        );
    }
    ...
    if (state == ns_antoc_body_state.CLASH) {
        ...
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.CLASH, counter + 1, integrity, stamina, dir, FALSE),
        );
    }
    ...
    if (state == ns_antoc_body_state.JUMP) {
        ...
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.JUMP, counter + 1, integrity, stamina, dir, FALSE),
        );
    }
    ...
    if (state == ns_antoc_body_state.STEP_FORWARD) {
        ...
        if (enough_stamina == TRUE) {
            if (intent == ns_antoc_action.VERT) {
                return (
                    body_state_nxt=BodyState(ns_antoc_body_state.VERT, 3, integrity, updated_stamina, dir, FALSE),
                );
            }
        }
        ...
        return (
            body_state_nxt=BodyState(ns_antoc_body_state.STEP_FORWARD, counter + 1, integrity, stamina, dir, FALSE),
        );
    }
