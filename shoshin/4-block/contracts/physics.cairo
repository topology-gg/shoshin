...
func _physicality{range_check_ptr}(
    ...
    let (bool_object_in_punch_atk_0) = ns_object_qualifiers.is_object_in_punch_atk(
        curr_object_state_0
    );
    let (bool_object_in_punch_atk_1) = ns_object_qualifiers.is_object_in_punch_atk(
        curr_object_state_1
    );
    ...
    let (bool_object_in_active_0_) = _bool_or(
        bool_object_in_punch_atk_0, bool_object_in_power_atk_0
    );
    ...
    let (bool_object_in_active_1_) = _bool_or(
        bool_object_in_punch_atk_1, bool_object_in_power_atk_1
    );
    ...
    let curr_character_state_0 = CharacterState(
        pos=pos_0, dir=candidate_character_state_0.dir, int=int_0
    );
    let curr_character_state_1 = CharacterState(
        pos=pos_1, dir=candidate_character_state_1.dir, int=int_1
    );

    //
    // 7. Produce stimuli
    //
    let curr_stimulus_0_ = bool_agent_0_hit * (bool_object_in_punch_atk_1 * ns_stimulus.HIT_BY_PUNCH + bool_object_in_power_atk_1 * ns_stimulus.HIT_BY_POWER);
    let curr_stimulus_0 = curr_stimulus_0_ + bool_action_overlap * (
        bool_object_in_punch_atk_0 * bool_object_in_punch_atk_1 * ns_stimulus.CLASH_BY_PUNCH +
    ...
    let curr_stimulus_1_ = bool_agent_1_hit * (bool_object_in_punch_atk_0 * ns_stimulus.HIT_BY_PUNCH + bool_object_in_power_atk_0 * ns_stimulus.HIT_BY_POWER);
