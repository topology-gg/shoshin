...
func _loop{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    //
    // let (agent_state_0, a_0, agent_stm_0) = _agent (last_frame.agent_0.agent_state, perceptibles, last_frame.agent_0.agent_stm)
    let (agent_state_1, a_1, agent_stm_1) = _agent(
        last_frame.agent_1.agent_state, perceptibles, last_frame.agent_1.agent_stm
    );

    let agent_state_0 = last_frame.agent_0.agent_state;
    let a_0 = ns_action.MOVE_FORWARD;
    let agent_stm_0 = last_frame.agent_0.agent_stm;

    // let agent_state_1 = last_frame.agent_1.agent_state
    // let a_1 = ns_action.MOVE_FORWARD
