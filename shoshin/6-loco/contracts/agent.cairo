...
from contracts.constants import ns_action, Stm
...
func _expression_0{}(perceptibles: felt) -> (bool: felt) {
    return (0,);
}

func _expression_1{}(perceptibles: felt) -> (bool: felt) {
    return (1,);
}

func _agent{range_check_ptr}(state: felt, perceptibles: felt, stm: Stm) -> (
