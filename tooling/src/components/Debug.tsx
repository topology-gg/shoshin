...
export default function Debug({
    ...
    const bodyStateStateString: string =
        bodyStateNumberToName[characterName][agentFrame.body_state.state];
    const animationIndex: number =
        agentFrame.body_state.state + agentFrame.body_state.counter;
