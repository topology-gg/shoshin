...
export default function SettingModal({
    ...
    // compute props
    const modalWidth = modalMode == 'connect' ? 450 : 1100; // leaderboard width
        ...
        <div style={{ margin: '0 6px 0 0', verticalAlign: 'middle' }}>
            <Button onClick={handleOpen}>
                <i
                    ...
                    style={{ fontSize: '1rem', paddingTop: '0.1rem' }}
                >
                    settings
                </i>
            </Button>
            ...
            >
                ...
                >
                    {modalMode == 'connect' ? <ConnectWallet /> : <></>}
                </Box>
            </Modal>
        </div>
    );
