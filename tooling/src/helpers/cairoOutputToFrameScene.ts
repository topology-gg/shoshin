...
const cairoOutputToFrameScene = (output: any[]): FrameScene => {
    ...
    output.forEach((f) => {
        scene.agent_0.push({
            action: f.agent_0.action[0]
                ? f.agent_0.action[0] * f.agent_0.action[1][0]
                : 0,
            body_state: {
                ...
                state_index: f.agent_0.body_state.state_index[0]
                    ...
                    : 0,
                opponent_state_index_last_hit: f.agent_0.body_state.opponent_state_index_last_hit[0]
            ...
            combo: {
                combo_index: f.agent_0.combo.combo_index[0]
                    ? f.agent_0.combo.combo_index[0] *
                      f.agent_0.combo.combo_index[1][0]
                    : 0,
                action_index: f.agent_0.combo.action_index[0]
                    ? f.agent_0.combo.action_index[0] *
                      f.agent_0.combo.action_index[1][0]
                    : 0,
            },
            physics_state: {
                pos: {
            ...
            mental_state: f.agent_0.mental_state[0]
                ? f.agent_0.mental_state[0] * f.agent_0.mental_state[1][0]
                : 0,
        ...
        scene.agent_1.push({
            action: f.agent_1.action[0]
                ? f.agent_1.action[0] * f.agent_1.action[1][0]
                : 0,
            body_state: {
                ...
                state_index: f.agent_1.body_state.state_index[0]
                    ...
                    : 0,
                opponent_state_index_last_hit: f.agent_1.body_state.opponent_state_index_last_hit[0]
            ...
            combo: {
                combo_index: f.agent_1.combo.combo_index[0]
                    ? f.agent_1.combo.combo_index[0] *
                      f.agent_1.combo.combo_index[1][0]
                    : 0,
                action_index: f.agent_1.combo.action_index[0]
                    ? f.agent_1.combo.action_index[0] *
                      f.agent_1.combo.action_index[1][0]
                    : 0,
            },
            physics_state: {
                pos: {
